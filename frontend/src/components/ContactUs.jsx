                ...
                <div className="w-[90%] lg:w-[80%] mx-auto">
                    ...
                    <div className='flex flex-col-reverse lg:flex-row justify-between gap-10 items-center my-14 lg:my-20 overflow-hidden'>
                        <div className='w-full lg:w-1/2'>
                            ...
                            <div>
                                <h1 className='flex items-center gap-3 text-2xl md:text-3xl lg:text-2xl xl:text-4xl font-[BelfastGrotesk]'>Get In <h1 className='text-[#018D43]'>Touch</h1> With Us</h1>
                            </div>
                            ...
                            <form className='flex flex-col gap-4 mt-5' action="">
                                <input className='w-full outline-[#018D43] border border-gray-300 rounded-full placeholder:text-gray-500 !font-[400] placeholder:text-sm px-4 py-3' type="text" placeholder='Your Name*' />
                                <input className='w-full outline-[#018D43] border border-gray-300 rounded-full placeholder:text-gray-500 !font-[400] placeholder:text-sm px-4 py-3' type="text" placeholder='Your Email*' />
                                <textarea className='w-full outline-[#018D43] border border-gray-300 rounded-3xl placeholder:text-gray-500 !font-[400] placeholder:text-sm px-4 py-3 min-h-32' name="" placeholder='Question*' id="" ></textarea>
                                <button className='bg-[#018D43] text-white w-fit px-7 py-3 rounded-full'>Send Message</button>
                            </form>
                        </div>
                        <iframe className='rounded-2xl h-52 md:h-80 lg:h-96 w-full lg:w-1/2' src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d378.2265895210637!2d72.84249545774274!3d21.196808276046106!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be04ef22a0178b1%3A0x2f02ec2c91fcd100!2sVision%20Infotech!5e0!3m2!1sen!2sin!4v1761055425289!5m2!1sen!2sin" style={{ border: 0 }} allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                    </div>
                            ...
                            <div className='mt-7 grid grid-cols-1 xl:grid-cols-2 gap-0 gap-x-10'>
                                <div>
                                    <div className='flex items-start gap-5'>
                                        ...
                                        <div>
                                            <p>Address</p>
                                            <span className='text-gray-600 text-sm'>7563 St. Vicent Place, Glasgow</span>
                                        </div>
                                    </div>
                                ...
                                <div>
                                    <div className='flex items-start gap-5'>
                                        ...
                                        <div>
                                            <p>Hours</p>
                                            <span className='text-gray-600 text-sm'>7 Days a week from 10:00 am to 6:00 pm</span>
                                        </div>
                                    </div>
                                    <hr className='w-full my-3 border' />
                                </div>
                                <div>
                                    <div className='flex items-start gap-5'>
                                        ...
                                        <div>
                                            <p>Phone</p>
                                            <span className='text-gray-600 text-sm'>+09123 456 789</span>
                                        </div>
                                    </div>
                                ...
                                <div>
                                    <div className='flex items-start gap-5'>
                                        ...
                                        <div>
                                            <p>E-mail</p>
                                            <span className='text-gray-600 text-sm'>zemes@demolink.org</span>
                                        </div>
                                    </div>
                                    <hr className='w-full my-3 border xl:hidden' />
                                </div>
